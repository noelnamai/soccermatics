...
NULL
#' Draws soccer pitch outlines over an existing ggplot object
#'
#' Draws soccer pitch outlines (with transparent fill) over an existing ggplot 
#' object to provide context for heatmaps, passing maps, etc..
#' 
