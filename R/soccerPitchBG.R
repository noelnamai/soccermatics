...
NULL
#' Draws a soccer pitch as a background ggplot object.
#'
#' Draws a soccer pitch as a ggplot object for the purpose of adding player
#' positions, player trajectories, etc..
#' 
